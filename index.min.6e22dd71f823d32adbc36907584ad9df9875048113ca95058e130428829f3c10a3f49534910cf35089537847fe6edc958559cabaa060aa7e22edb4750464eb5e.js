...
`}),e.add({id:1,href:"/docs/wiki/",title:"Wiki",description:"",content:""}),e.add({id:2,href:"/docs/wiki/installation/",title:"Instalation",description:`Dependencies # Windows binaries and executables: https://github.com/stotiks/mmx-node/releases
...
`}),e.add({id:3,href:"/docs/wiki/getting-started/",title:"Getting Started",description:`To continue enter the CLI environment:
...
`}),e.add({id:4,href:"/docs/wiki/cli-commands/",title:"CLI Commands",description:`To use the CLI:
...
`}),e.add({id:5,href:"/docs/wiki/access-webgui/",title:"Access WebGUI",description:`To access WebGUI, go to: http://localhost:11380/gui/
Check $MMX_HOME/PASSWD for the login password, it\u0026rsquo;s automatically generated at first launch.
...
`}),e.add({id:7,href:"/docs/wiki/remote-services/",title:"Remote Services",description:`These steps are provided for farming on many machines on a single local area network, or even over a wide area network.
...
`}),e.add({id:9,href:"/docs/wiki/frequently-asked-questions/",title:"FAQ",description:`When is mainnet launch? # Current latest estimate is Q2 2023.
...
`}),e.add({id:10,href:"/docs/",title:"Docs",description:"Docs Doks.",content:""}),search.addEventListener("input",t,!0);function t(){const s=5;var n=this.value,o=e.search(n,{limit:s,enrich:!0});const t=new Map;for(const e of o.flatMap(e=>e.result)){if(t.has(e.doc.href))continue;t.set(e.doc.href,e.doc)}if(suggestions.innerHTML="",suggestions.classList.remove("d-none"),t.size===0&&n){const e=document.createElement("div");e.innerHTML=`No results for "<strong>${n}</strong>"`,e.classList.add("suggestion__no-results"),suggestions.appendChild(e);return}for(const[r,a]of t){const n=document.createElement("div");suggestions.appendChild(n);const e=document.createElement("a");e.href=r,n.appendChild(e);const o=document.createElement("span");o.textContent=a.title,o.classList.add("suggestion__title"),e.appendChild(o);const i=document.createElement("span");if(i.textContent=a.description,i.classList.add("suggestion__description"),e.appendChild(i),suggestions.appendChild(n),suggestions.childElementCount==s)break}}})()